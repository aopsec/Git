...
## 7. Pontos abertos de refinamento editorial

Decisões pendentes:

1. Inserir identificação institucional completa na capa (`disciplina`, `curso`, `autor`, `docente`)?
2. Expandir a metodologia de seleção das fontes governamentais em uma subseção própria?
3. Adicionar um apêndice comparando `MXQ Pro 4K`, TV box homologado e OpenB0X sob critérios de risco?
